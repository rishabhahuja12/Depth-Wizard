...
In [`frontend/src/components/Dropzone.tsx`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src/components/Dropzone.tsx#L210-L300), the UI contains two pre-configured testbed cards:

| Preset Name | UI Identifier | Source File Location | File Size | Description |
|---|---|---|---|---|
| **Testbed A (GeoTIFF)** | `real_satellite_georef.tif` | [`frontend/public/sample_satellite_georef.tif`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/public/sample_satellite_georef.tif) | `3.1 MB` | A genuine georeferenced satellite tile with embedded CRS (`EPSG:32617`), affine matrix, and calculated physical Ground Sampling Distance (GSD). Triggers metric elevation mode (meters). |
| **Testbed B (Optical)** | `real_satellite_urban.png` | [`frontend/public/sample_satellite_urban.png`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/public/sample_satellite_urban.png) | `2.4 MB` | A dense high-resolution urban satellite tile without CRS metadata. Triggers relative elevation mode $[0.0, 1.0]$. |
...
In addition to the public folder assets, the root directory includes offline evaluation sets in [`test_datasets/`](file:///Users/tanishporwal/Desktop/depthwizard/test_datasets):
* [`test_datasets/geotiff_mode/`](file:///Users/tanishporwal/Desktop/depthwizard/test_datasets/geotiff_mode):
...
* [`test_datasets/optical_mode/`](file:///Users/tanishporwal/Desktop/depthwizard/test_datasets/optical_mode):
...
* **Module**: [`app/services/geospatial.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/geospatial.py)
* **Function**: `read_image()`
...
* **Module**: [`app/services/depth_estimator.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/depth_estimator.py)
...
* **Module**: [`app/services/calibration.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/calibration.py)
...
* **Module**: [`app/services/mesh_builder.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/mesh_builder.py)
...
* **Module**: [`frontend/src/components/TerrainCanvas.tsx`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src/components/TerrainCanvas.tsx)
