...
### Stage 1: Geospatial Ingestion ([`backend/app/services/geospatial.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/geospatial.py))
...
### Stage 2: AI Depth Inference ([`backend/app/services/depth_estimator.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/depth_estimator.py))
* **Backbone**: `Depth-Anything-V2-Small-hf` (Vision Transformer, ~24.8M parameters).
* **Fine-Tuned Checkpoint**: [`backend/weights/best_model.pth`](file:///Users/tanishporwal/Desktop/depthwizard/backend/weights/best_model.pth) adapted on `earthflow/GAMUS` (DFC 2019 aerial optical + LiDAR nDSM ground truth).
...
### Stage 3: Two-Component Elevation Calibration ([`backend/app/services/calibration.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/calibration.py))
...
### Stage 4: Mesh Synthesis & Decimation ([`backend/app/services/mesh_builder.py`](file:///Users/tanishporwal/Desktop/depthwizard/backend/app/services/mesh_builder.py))
...
## 4. Frontend 3D Studio & Features ([`frontend/src/`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src))

* **Main 3D Viewport**:
  * **Voxel / Block Mode ([`VoxelTerrain.tsx`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src/components/VoxelTerrain.tsx))**: Quantized block extrusion using `THREE.InstancedMesh` (single draw call). Ground-anchored at $y=0$, configurable discrete Turbo elevation bands (5–12), block resolution slider (24–96), and Minecraft-style block gap margins.
  * **Smooth Photoreal Mode ([`TerrainCanvas.tsx`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src/components/TerrainCanvas.tsx))**: Continuous Three.js `PlaneGeometry` vertex displacement with dynamic runtime GLSL contour lines (`fwidth()`).
* **Photoreal Minimap ([`Minimap.tsx`](file:///Users/tanishporwal/Desktop/depthwizard/frontend/src/components/Minimap.tsx))**: Floating top-right overlay running a locked, non-interactive second WebGL canvas for overview reference.
