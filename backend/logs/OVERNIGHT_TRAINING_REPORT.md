...
1. **Best Model Checkpoint**: `E:\rishabh\sih\DepthWizard\backend\weights\best_model.pth`
2. **Production Inference Weights**: `E:\rishabh\sih\DepthWizard\backend\weights\final_model.pth`
3. **Periodic Snapshots**: `E:\rishabh\sih\DepthWizard\backend\weights\checkpoints`
4. **Structured Telemetry**: `E:\rishabh\sih\DepthWizard\backend\logs\training_full_overnight.jsonl`
5. **Raw Execution Log**: `E:\rishabh\sih\DepthWizard\backend\logs\training_full_overnight.log`
